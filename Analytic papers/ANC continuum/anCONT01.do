...
*-------------------------------------------------------------------------------
	global keepvars anctotal manctotal months totvisits bpthree wgtthree bloodthre urinethre ///
	totalus all4 anc1_bp anc1_weight anc1_blood anc1_urine site ///
...
*-------------------------------------------------------------------------------
	...
	* Minimum set of ANC items
	...
	by country, sort: tabstat anctotal months manctotal, stat(mean med count) col(stat)
