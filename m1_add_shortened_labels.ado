...
capture label var m1_705 "Today's visit did provider: Take a urine sample (that is, you peed in a container)"
...
capture label var m1_715 "Today's visit: Provided an insecticide treated bed net to prevent malaria"
...
capture label var m1_724f "Today's visit: Told to go somewhere else for urine test (lab or health facility)"
...
capture label var m1_801 "Today's visit: Today's visit: Provider gave you an estimated due date"
...
capture label var m1_815_0 " Provider health problem advise: Nothing, we did not discuss this"
capture label var m1_815_2 " Provider advised for health problems: Get a lab test or imaging"
...
capture label var m1_815_5 " Provider advised for health problems: Come back to this health facility"
capture label var m1_815_6 " Provider advised for health problems:Go elsewhere for higher level care"
capture label var m1_815_7 " Provider advised for health problems: Wait and see"
...
capture label var m1_1011f "Today's visit provider discussed: Baby that died within their first month of life"
...
if "${Country}" == "ET" {
	...
	capture label var respondentid "Respondent id ((Inerviewer ID+ Facility ID+ Respondent sequencial number)"
	...
	capture label var kebele_intworm "ET: Interviewer check whether the area that the woman living is endemic for intestinal worm or not?"
	...
	capture label var m1_403a_et "ET: Do you know the distance from your home to the facility?"
	...
	capture label var muac_et "ET: Measured Upper arm circumference"
...
if "${Country}" == "KE" {
	...
	capture label var m1_804 "Program calculated gestational age"
	capture label var m1_805a_ke "KE: Please refer to the chart to confirm the number of babies that the respondent is expecting."
