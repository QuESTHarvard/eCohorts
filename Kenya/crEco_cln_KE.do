...
label variable m2_507_1_ke "507. KE only: "
label variable m2_507_2_ke (s" if q_518 == "-96"
replace q_518 = "Other reasons(specify)" if q_518 == "-97"
replace q_518 = "Don't Know" if q_518 == "-98"
replace q_518 = "NR/RF" if q_518 == "-99"
rename (q_518)(m3_518)
...
label variable m2_507 "507. What did the health care provider tell you to do regarding these new symptoms?"
label variable m2_507_1_ke "507. KE only: "
label variable m2_507_2_ke "507. KE only: "
label variable m2_507_3_ke (s" if q_518 == "-96"
replace q_518 = "Other reasons(specify)" if q_518 == "-97"
replace q_518 = "Don't Know" if q_518 == "-98"
replace q_518 = "NR/RF" if q_518 == "-99"
rename (q_518)(m3_518)
...
label variable m2_509 "Since we last spoke, did a health care provider tell you:"
...
order m2_attempt_number m2_attempt_number_other m2_attempt_outcome m2_resp_lang1 ///
	  m2_resp_lang2 m2_resp_lang_other m2_attempt_relationship m2_attempt_other ///
	  m2_attempt_avail m2_attempt_contact m2_attempt_bestnumber m2_attempt_goodtime ///
	  m2_reschedule_resp m2_completed_attempts m2_consent_recording m2_consent ///
	  m2_date m2_start_time m2_date_time m2_time_start m2_interviewer m2_respondentid ///
	  m2_baseline_ga m2_baseline_date m2_maternal_death_reported m2_date_of_maternal_death ///
	  m2_ga m2_ga_estimate m2_hiv_status m2_maternal_death_learn m2_maternal_death_learn_other, before(m2_201)
