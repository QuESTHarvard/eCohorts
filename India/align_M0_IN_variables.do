* Bring in the IN M0 dataset
use "${in_data_final}/eco_m0_in", clear

replace m0_urban = 1 if m0_urban == "Urban"
replace m0_urban = 2 if m0_urban == "Rural"
destring m0_urban, replace
